...
export const RoundedButton = ({ children, className, icon, isPending, alt = '', ...props }: { children?: React.ReactNode; className?: string; icon?: string | StaticImageData; isPending?: boolean; alt?: string } & ButtonProps) => {
